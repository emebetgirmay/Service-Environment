...
# --- Optional NAT Gateway (var.enable_nat_gateway) ----------------------
# Off by default — see the variable's description. One NAT GW in the first
# public subnet is enough for a lab; not one-per-AZ.
